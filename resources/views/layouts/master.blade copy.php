...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="{{ asset('myjs.js') }}"></script>
    <!-- Responsive CSS -->
  ...
  <body>
        ...
        <div class="menu-list">
          ...
          <ul id="menu-content" class="menu-content collapse out">
            ...
            <li data-toggle="collapse" data-target="#{{$Cat->name}}" class="collapsed ">
              <a href="#{{$Cat->id}}">{{$Cat->name}}<span class="arrow"></span></a>
              
            
              <ul class="sub-menu collapse" id="{{$Cat->name}}" >
              @foreach($Cat->subcategory as $sub )
                <li ><a href="shop/{{$sub->id}}" >{{$sub->name}}</a></li>
                @endforeach
              </ul>
    ...
    //  alert('hello');
      ...
      var prix =document.getElementById("myPrice").innerText;
      document.getElementById("totalprice").innerHTML=qte*prix;
