                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 top-cart-row no-margin">
                        <div class="top-cart-row-container">
                            ...
                            <div class="top-cart-holder dropdown animate-dropdown">
                                <div class="basket">
                                  <div>
                                        <div class="basket-item-count" style="float:left;">
                                            <span class="count">{{Cart::content()->count()}}</span>
                                            <a href="mycart"><img src="{{ asset('images/icon-cart.png')}}" alt="" /></a>
                                        </div>
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="float:left;">
                                        <div class="total-price-basket" style="float:left;">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <div class="basket-item">
                                                <div class="row">
                                                    <div class="col-xs-4 col-sm-4 no-margin text-center">
                                                        ...
                                                        @if($cart->options->image!=null)
                                                            <img style="width:73px;height:73px;" alt="" src="{{$cart->options->image}}" />
                                                        @else
                                                        <img style="width:73px;height:73px;" alt="" src="{{asset('images/products/new_product.jpg')}}" />
                                                        @endif
                                                        </div>
                                                    </div>
                                                ...
                                                <a class="close-btn" href="destroyindex/{{$cart->rowId}}"></a>
                                            </div>
                                        </li>
                                        @endforeach
                                    ...
                                    <ul>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="{{asset('images/blank.gif')}}" data-echo="{{asset('images/products/product-small-01.jpg')}}" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="{{asset('images/blank.gif')}}" data-echo="{{asset('images/products/product-small-02.jpg')}}" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="{{asset('images/blank.gif')}}" data-echo="{{asset('images/products/product-small-03.jpg')}}" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="{{asset('images/blank.gif')}}" data-echo="{{asset('images/products/product-small-04.jpg')}}" />
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="{{asset('images/blank.gif')}}" data-echo="{{asset('images/products/product-small-05.jpg')}}" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="{{asset('images/blank.gif')}}" data-echo="{{asset('images/products/product-small-06.jpg')}}" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="{{asset('images/blank.gif')}}" data-echo="{{asset('images/products/product-small-07.jpg')}}" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="{{asset('images/blank.gif')}}" data-echo="{{asset('images/products/product-small-08.jpg')}}" />
                                                    </a>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-3 no-margin">
                                                    <a href="#" class="thumb-holder">
                                                        <img alt="" src="{{asset('images/blank.gif')}}" data-echo="{{asset('images/products/product-small-09.jpg')}}" />
                                                    </a>
                                                </div>
