...
<body>
    ...
    <div id="wrapper">
        ...
        @foreach($Pieces as $b)
        <div class="modal fade" id="myModal-{{$b->id}}" tabindex="-1" role="dialog" aria-labelledby="quickview" aria-hidden="true">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-7">
                                        <div class="quickview_pro_des">
                                            ...
                                            <p>{{$b->Caracteristique}}</p>
                                            <a href="{{route('details',$b->id)}}">View Full Product Details</a>
                                        </div>
                                        <!-- Add to Cart Form -->
                        ...
                        @foreach($Pieces as $pieces)
                             ...
                             <div class="col-12 col-sm-6 col-lg-4 single_gallery_item wow fadeInUpBig" data-wow-delay="0.2s">
                                    ...
                                    <div class="product-img">
                                        <img src="{{asset($pieces->image)}}" alt="">
                                        <div class="product-quicview">
                                            <a href="#" data-toggle="modal" data-target="#myModal-{{$pieces->id }}" ><i class="ti-more-alt"></i></a>
                                        </div>
                                    </div>
                                    <!-- Product Description -->
                                    <div class="product-description">
                                        <h4 class="product-price">${{$pieces->prix}}</h4>
                                        <p>{{$pieces->name}}</p>
                                        <!-- Add to Cart -->
