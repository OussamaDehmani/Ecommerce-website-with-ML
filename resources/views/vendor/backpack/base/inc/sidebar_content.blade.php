...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('commande') }}'><i class='nav-icon la la-shopping-cart'></i> Commandes</a></li>

<li class='nav-item'><a class='nav-link' href='{{ backpack_url('piece') }}'><i class='nav-icon la la-tachometer-alt'></i> Pieces</a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('comment') }}'><i class='nav-icon la la-comments'></i> Comments</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('piece_user') }}'><i class='nav-icon la la-question'></i> Rate</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('image') }}'><i class='nav-icon la la-image'></i> Piece Images</a></li>
